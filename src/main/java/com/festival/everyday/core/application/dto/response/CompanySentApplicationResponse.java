...
@Builder
@AllArgsConstructor
public class CompanySentApplicationResponse {
    ...
    public static CompanySentApplicationResponse of(Application application) {
        Festival festival=application.getFestival();
        Holder holder=festival.getHolder();

        return CompanySentApplicationResponse.builder()
