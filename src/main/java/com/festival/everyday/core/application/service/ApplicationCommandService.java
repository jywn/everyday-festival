...
public class ApplicationCommandService {
    ...
    public Long createCompanyApplication(Long userId, Long festivalId, ApplicationRequest request) {
        ...
        Festival festival = festivalRepository.findFestivalWithCompanyRecruit(festivalId).orElseThrow(FestivalNotFoundException::new);
    ...
    public Long createLaborApplication(Long userId, Long festivalId, ApplicationRequest request) {
        ...
        // 쿼리 튜닝 -> 페치 조인을 적용해 축제와 공고를 조회합니다. + 기획자 fetch
        Festival festival = festivalRepository.findFestivalWithLaborRecruit(festivalId).orElseThrow(FestivalNotFoundException::new);
